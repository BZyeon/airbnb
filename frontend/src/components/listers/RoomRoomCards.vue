    ...
    <div>
        ...
        >
            <v-row>
                <v-list-item class="d-flex">
                    ...
                    <h1 class="align-self-center ml-3">Room</h1>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <RoomRoom :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row>
            <RoomRoom :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
...
<script>
    ...
    import RoomRoom from './../RoomRoom.vue';
    ...
    export default {
        ...
        async created() {
            ...
            me.values = temp.data._embedded.rooms;
